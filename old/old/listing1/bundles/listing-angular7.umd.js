(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/collections'), require('ngx-uploader'), require('rxjs/operators'), require('@angular/common/http'), require('moment'), require('@angular/platform-browser'), require('@angular/cdk/a11y'), require('@angular/cdk/drag-drop'), require('@angular/cdk/portal'), require('@angular/cdk/scrolling'), require('@angular/cdk/stepper'), require('@angular/cdk/table'), require('@angular/cdk/tree'), require('@angular/core'), require('@angular/material'), require('@angular/platform-browser/animations'), require('@angular/forms'), require('@angular/common'), require('ngx-moment'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('listing-angular7', ['exports', '@angular/cdk/collections', 'ngx-uploader', 'rxjs/operators', '@angular/common/http', 'moment', '@angular/platform-browser', '@angular/cdk/a11y', '@angular/cdk/drag-drop', '@angular/cdk/portal', '@angular/cdk/scrolling', '@angular/cdk/stepper', '@angular/cdk/table', '@angular/cdk/tree', '@angular/core', '@angular/material', '@angular/platform-browser/animations', '@angular/forms', '@angular/common', 'ngx-moment', '@angular/router'], factory) :
    (factory((global['listing-angular7'] = {}),global.ng.cdk.collections,global.ngxUploader,global.rxjs.operators,global.ng.common.http,global.momentImported,global.ng.platformBrowser,global.ng.cdk.a11y,global.ng.cdk['drag-drop'],global.ng.cdk.portal,global.ng.cdk.scrolling,global.ng.cdk.stepper,global.ng.cdk.table,global.ng.cdk.tree,global.ng.core,global.ng.material,global.ng.platformBrowser.animations,global.ng.forms,global.ng.common,global.ngxMoment,global.ng.router));
}(this, (function (exports,collections,ngxUploader,operators,http,momentImported,platformBrowser,a11y,dragDrop,portal,scrolling,stepper,table,tree,i0,material,animations,forms,common,ngxMoment,router) { 'use strict';

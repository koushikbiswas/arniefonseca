...
export class AddEditVideosComponent implements OnInit {
  ...
  constructor(public router : Router, public activeRoute: ActivatedRoute,public apiService : ApiService, public cookies :CookieService, public   readonly meta: MetaService) { 

...
public seminer:any;
  ...
  constructor(private activatedRoute: ActivatedRoute, private router: Router, public apiService: ApiService, private readonly meta: MetaService,private sanitizer: DomSanitizer ) {
    ...
    this.meta.setTitle('Arniefonseca - Event Seminars Detail');
    ...
    this.meta.setTag('og:title', 'Arniefonseca - Event Seminars Detail');
    this.meta.setTag('twitter:title', 'Arniefonseca - Event Seminars Detail');
